...
def asynchronize(framework,
                 sync_method,
                 doc=...,
                 wrap_class=...,
                 unwrap_class=...):  # -> (self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown:
...
class Async(MotorAttributeFactory):
    ...
    def wrap(self, original_class):  # -> Async:
        ...

    def unwrap(self, class_name):  # -> Async:
        ...
...
class DelegateMethod(ReadOnlyProperty):
    ...
    def wrap(self, original_class):  # -> DelegateMethod:
        ...

    def create_attribute(
            self, cls,
            attr_name):  # -> property | (self_: Unknown, *args: Unknown, **kwargs: Unknown) -> ((Unknown | Any)):
        ...
