...
async def test_after_save() -> None:
    doc = Motor()
    await doc.save()
...
async def test_before_update() -> None:
    doc = Motor()
...
async def test_after_update() -> None:
    doc = Motor()
...
async def test_before_create() -> None:
    doc = Motor()
...
async def test_after_create() -> None:
    doc = Motor()
...
async def test_before_delete() -> None:
    doc = Motor()
...
async def test_after_delete() -> None:
    doc = Motor()
