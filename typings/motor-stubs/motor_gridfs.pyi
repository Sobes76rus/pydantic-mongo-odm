...
class AgnosticGridIn:
    ...
    async def write(self, data: Union[str, bytes, IO[Any]]) -> None:
        ...
    ...
    def __init__(self, root_collection, delegate=..., session=..., disable_md5=..., **kwargs) -> None:
        """
...
class AgnosticGridFSBucket:
    ...
    def open_download_stream(self, file_id: Any) -> Awaitable[AgnosticGridOut]:
        ...
