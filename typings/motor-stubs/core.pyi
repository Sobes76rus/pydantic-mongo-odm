...
class AgnosticClient(AgnosticBaseProperties):
    ...
    def __getattr__(self, name: str):  # -> _:
        ...

    def __getitem__(self, name: str):  # -> _:
        ...
...
class AgnosticClientSession(AgnosticBase):
    ...
    def start_transaction(self,
                          ...
                          write_concern=...,
                          read_preference=...,
                          max_commit_time_ms=...):  # -> _MotorTransactionContext:
...
class AgnosticDatabase(AgnosticBaseProperties):
    ...
    def aggregate(self, pipeline, **kwargs: Any):  # -> _:
    ...
    def wrap(self, obj):  # -> _ | AgnosticDatabase:
        ...
...
class AgnosticCollection(AgnosticBaseProperties):
    ...
    def delete_one(*args, **kwargs: Any) -> Awaitable[DeleteResult]:
        ...
    ...
    async def find_one(*args, **kwargs: Any) -> Optional[Dict[str, Any]]:
        ...
    ...
    def insert_many(*args, **kwargs: Any) -> Awaitable[InsertManyResult]:
        ...

    def insert_one(*args, **kwargs: Any) -> Awaitable[InsertOneResult]:
        ...
    ...
    def update_many(*args, **kwargs: Any) -> Awaitable[UpdateResult]:
        ...

    def update_one(*args, **kwargs: Any) -> Awaitable[UpdateResult]:
        ...
    ...
    def find(self, *args: Any, **kwargs: Any) -> AgnosticCursor:  # -> _:
    ...
    def aggregate(self, pipeline: list[dict[str, Any]], **kwargs: Any) -> Awaitable[list[dict[str, Any]]]:  # -> _:
    ...
    def wrap(self, obj):  # -> AgnosticCollection | AgnosticCursor | _:
        ...
...
class AgnosticBaseCursor(AgnosticBase):
    ...
    def to_list(self, length: Optional[int]) -> Awaitable[List[Dict[str, Any]]]:
    ...
    async def close(self):  # -> Coroutine[Any, Any, Unknown] | None:
...
class AgnosticCursor(AgnosticBaseCursor):
    ...
    def __deepcopy__(self, memo):  # -> AgnosticCursor:
        ...
...
class AgnosticLatentCommandCursor(AgnosticCommandCursor):
    ...
    def batch_size(self, batch_size):  # -> AgnosticLatentCommandCursor:
        ...
...
class AgnosticChangeStream(AgnosticBase):
    ...
    def __init__(self, target, pipeline, full_document, resume_after, max_await_time_ms, batch_size, collation,
                 start_at_operation_time, session, start_after) -> None:
        ...
